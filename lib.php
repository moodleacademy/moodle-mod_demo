...
/**
 * Extends the global navigation tree by adding mod_demo nodes if there is a relevant content.
 *
 * This can be called by an AJAX request so do not rely on $PAGE as it might not be set up properly.
 *
 * @param navigation_node $demonode An object representing the navigation tree node.
 * @param stdClass $course
 * @param stdClass $module
 * @param cm_info $cm
 */
function demo_extend_navigation($demonode, $course, $module, $cm) {
}

/**
 * Extends the settings navigation with the mod_demo settings.
 *
 * This function is called when the context for the page is a mod_demo module.
 * This is not called by AJAX so it is safe to rely on the $PAGE.
 *
 * @param settings_navigation $settingsnav {@see settings_navigation}
 * @param navigation_node $demonode {@see navigation_node}
 */
function demo_extend_settings_navigation($settingsnav, $demonode = null) {
}
